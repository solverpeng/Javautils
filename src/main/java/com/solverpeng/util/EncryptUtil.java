...
public abstract class EncryptUtil {
     ...
     * @return Base64密文
     */
    public static String encryptDES2Base64(byte[] data, byte[] key) {
        return EncodeUtil.encodeBase64(encryptDES(data, key));
    }
     ...
     * @return 明文
     */
    public static byte[] decryptBase64DES(String data, byte[] key) {
        return decryptDES(EncodeUtil.decodeBase64(data), key);
    }
     ...
     * @return Base64密文
     */
    public static String encrypt3DES2Base64(byte[] data, byte[] key) {
        return EncodeUtil.encodeBase64(encrypt3DES(data, key));
    }
     ...
     * @return 明文
     */
    public static byte[] decryptBase64_3DES(String data, byte[] key) {
        return decrypt3DES(EncodeUtil.decodeBase64(data), key);
    }
     ...
     * @return Base64密文
     */
    public static String encryptAES2Base64(byte[] data, byte[] key) {
        return EncodeUtil.encodeBase64(encryptAES(data, key));
    }
     ...
     * @return 明文
     */
    public static byte[] decryptBase64AES(String data, byte[] key) {
        return decryptAES(EncodeUtil.decodeBase64(data), key);
    }
